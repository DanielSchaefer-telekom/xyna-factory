...
public class H5XdevFilter extends ConnectionFilter<HTTPTriggerConnection> {
  ...
  public static final XynaPropertyBoolean USE_CACHE = new XynaPropertyBoolean("xmcp.guihttp.use_cache", true)
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE, "Cache verwenden, um auf zuletzt verwendete Objekte schneller zugreifen zu k�nnen. Die Gr��e des Caches wird durch " + cache_size_property_name + " bestimmt.");
  ...
  public static final XynaPropertyBoolean CompressResponse = new XynaPropertyBoolean("xmcp.guihttp.compress_response", true)
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE, "Antwort mit gzip komprimieren, wenn es vom Aufrufer unterst�tzt wird.");
  ...
  public static final XynaPropertyBoolean STRICT_TRANSPORT_SECURITY = new XynaPropertyBoolean("xmcp.guihttp.sts", true)
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE, "Session Cookie als __Secure- senden und Strict-Transport-Security Header einf�gen. Ben�tigt einen HTTPS-Trigger.");
  ...
  public static final XynaPropertyString VALIDATION_WORKFLOW = new XynaPropertyString("xmcp.guihttp.startorder.preprocess_workflow", "")
      ...
      .setDefaultDocumentation(DocumentationLanguage.DE, "Falls gesetzt, werden alle startorder-Requests au�erhalb von GuiHttp zuerst vom angegebenen Workflow verarbeitet. Inputs sind Document und Ordertype, Output ist Document. Format: <fqn>@<rtc>. <rtc> ist entweder workspaceName oder applicationName/versionName.");
